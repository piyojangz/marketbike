...
public class UserAdapter extends BaseAdapter implements Transformation {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mHighlightedPositions[position]) {
            btn_request_friend.setBackgroundResource(R.drawable.ic_rq_friend_1);
        } else {
            if (status.equals("1")) {
                btn_request_friend.setBackgroundResource(R.drawable.ic_rq_friend_1);
            } else {
                btn_request_friend.setBackgroundResource(R.drawable.ic_rq_friend);
            }
        }
            ...
            public void onClick(final View v) {
                ...
                new AsyncTask<Void, Void, Void>() {
                    ...
                    protected void onPostExecute(Void result) {
                        ...
                        if (mHighlightedPositions[position]) {
                            button.setBackgroundResource(R.drawable.ic_rq_friend);
