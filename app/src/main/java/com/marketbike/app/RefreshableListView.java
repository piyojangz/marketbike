...
public class RefreshableListView extends FrameLayout {
    ...
    private int itemsFromBottom = 20;
    private AbsoluteLayout btn_add_item2;
    private int mLastFirstVisibleItem, mLastVisibleItemCount;
    private boolean FLAG_SCROLL = false;
    private boolean FLAG_HAS_ADD_BUTTON = false;
    ...
    public void setAddButton(AbsoluteLayout wrap_item) {
        this.btn_add_item2 = wrap_item;
        this.FLAG_HAS_ADD_BUTTON = true;
    }
    ...
    class ListControl extends ListView implements OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            if (FLAG_HAS_ADD_BUTTON) {
                if (mLastFirstVisibleItem > firstVisibleItem && FLAG_SCROLL) {

                    Animation anim = AnimationUtils.loadAnimation(getContext(), R.anim.slide_from_bottom);
                    btn_add_item2.startAnimation(anim);
                    btn_add_item2.setAnimation(anim);
                    btn_add_item2.setVisibility(View.VISIBLE);
                    FLAG_SCROLL = false;

                } else if (mLastFirstVisibleItem < firstVisibleItem) {

                    if ((mLastFirstVisibleItem - firstVisibleItem) < 1000 && !FLAG_SCROLL) {
                        Animation anim = AnimationUtils.loadAnimation(getContext(), R.anim.slide_from_top);
                        btn_add_item2.startAnimation(anim);
                        btn_add_item2.setAnimation(anim);
                        ...
                        anim.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationEnd(Animation arg0) {
                                btn_add_item2.setVisibility(View.GONE);
                            }
                        });
